...
const RULES: RegexRule[] = [
  ...
  {
    type: "reference",
    pattern: /\b(?:Referenz|Ref\.|Kunden(?:-?nummer)?|Kd\.-Nr\.|Vorgangs(?:-?nummer)?|Rechnungs(?:-?nummer)?|RG\.-Nr\.|Auftrags(?:-?nummer)?|Beleg(?:-?nummer)?|Ticket(?:-?nummer)?|Fall(?:-?nummer)?)\s*[:#]?\s*([A-Z0-9][\-A-Z0-9\/]{2,40})\b/gi,
    label: "REFERENCE",
    priority: 8,
  },
];
